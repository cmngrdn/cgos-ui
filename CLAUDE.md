...
|------|-------------|-------|
| Pill / filter chip / segmented toggle | `cgos-ui/ui/ControlChip` → `ChipToggle`, `ChipSelect`, `ChipGroup`+`ChipSegment` | 28px height, the only pill atom. Do not roll your own. |
